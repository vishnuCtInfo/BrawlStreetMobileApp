    ...
    return (
        <>
            <div className="ct_mobile_width">
                ...
                <NavLink href='/onboarding/step2'className='ct_mob_head pt-0'>
                    <img src={back_btn} alt='back-btn'/>
                </NavLink>
                <NavLink href='/onboard/wizard2' className="ct_blue_text ct_fw_600 ct_fs_14" style={{ textAlign: "right", fontSize: "15px" }} >SKIP TOUR</NavLink>
            </div>
                        ...
                        <div className="w-100">
                            <div className="ct_bottom_fixed w-100 ct_px_15">
                                ...
                                <div className="text-center mt-30">
                                    <NavLink to="/onboard/wizard1" className="ct_blue_text text-center ct_fw_600 ct_fs_14" >Next</NavLink>
                                </div>
