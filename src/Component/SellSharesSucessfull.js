...
function SellSharesSucessfull() {
    const navigate = useNavigate()
    const HandleSellOrderPlaced = () => {
        navigate("/sell/order/placed")
    }
    return (
        <>
                ...
                <div className="ct_login_bg ct_h-100 ">
                    ...
                    <div className="ct_white_bg pt-28 px-15 ct_h-100">
                        ...
                        <div className="py-2  ct_border_top d-flex align-items-center justify-content-between">
                            <p className="mb-0 ct_fs_18 ct_fw_700">TOTAL SELL</p>
                            <p className="mb-0 ct_fs_18 ct_fw_700">$10,911.30</p>
                        </div>
                    </div>
                    <div className="ct_grey_bg_clr ct_fixed_botom">
                        <a onClick={() => HandleSellOrderPlaced()} className="ct_button_blue ct_light_blue_btn ct_green_btn">SELL SHARES</a>
                    </div>
                </div>
            </div>
        </>
...
export default SellSharesSucessfull