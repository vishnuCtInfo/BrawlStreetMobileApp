...
import newLavel50 from "../img/new-level50.png"
function NewLevel50() {
  return (
    <>
      <div className="ct_mobile_width">
        <div className="ct_h-100" style={{
          backgroundImage: `url(${newLavel50})`,
            ...
            <div className="mt-4">
              <div className="position-relative text-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="88" height="77" viewBox="0 0 88 77" fill="none">
                  <g filter="url(#filter0_i_5877_2402)">
                    <path d="M44 0L72.2827 9.26464L87.3315 32.7235L82.1051 59.4L59.0489 76.8118H28.9511L5.89488 59.4L0.668457 32.7235L15.7173 9.26464L44 0Z" fill="#FFA800" />
                  </g>
                  <defs>
                    <filter id="filter0_i_5877_2402" x="0.667969" y="0" width="86.6641" height="76.8125" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                      ...
                      <feBlend mode="normal" in2="shape" result="effect1_innerShadow_5877_2402" />
                    </filter>
                  </defs>
                </svg>
                <h2 className="ct_new_level_position">50</h2>
              </div>
              <p className="ct_yellow_text_clr ct_fw_900 text-center mt-3 ct_fs_18 ct_letter_space_5 pb-20 mb-0"><i className="ct_fw_900">LEVEL NAME</i></p>
              <div className=" px-15">
