...
import newLavel30to39 from "../img/new_level_30-39.png"
function NewLevel30to39() {
  return (
    <>
      <div className="ct_mobile_width">
        <div className="ct_new_level_light_pink_bg ct_h-100 " style={{
          backgroundImage: `url(${newLavel30to39})`,
            ...
            <div className="mt-4">
              <div className="position-relative text-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="86" height="76" viewBox="0 0 86 76" fill="none">
                  <g filter="url(#filter0_i_5877_1273)">
                    <path d="M43 0L77.4006 14.9098L85.8968 48.4118L62.0909 75.2784H23.9091L0.103172 48.4118L8.59941 14.9098L43 0Z" fill="#F160A6" />
                  </g>
                  <defs>
                    <filter id="filter0_i_5877_1273" x="0.103516" y="0" width="85.793" height="75.2793" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                      ...
                      <feBlend mode="normal" in2="shape" result="effect1_innerShadow_5877_1273" />
                    </filter>
                  </defs>
                </svg>
                <h2 className="ct_new_level_position">30</h2>
              </div>
              <p className="ct_F160A6_text_clr ct_fw_900 text-center mt-3 ct_fs_18 ct_letter_space_5 pb-20 mb-0"><i className="ct_fw_900">LEVEL NAME</i></p>
              <div className=" px-15">
