...
import corner8red from "../img/8_corner_red.png"
import ticket from "../img/ticket.png"

function OpenGamesDetail() {
        ...
        <>
            <div className="ct_mobile_width">
                <div className="ct_login_bg ct_h-100 ">
                    ...
                    <div className="px-15 mb-30 position-relative">
...
export default OpenGamesDetail