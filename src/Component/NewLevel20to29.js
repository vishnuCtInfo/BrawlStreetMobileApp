...
import newLavel20to29 from "../img/new_level_20-29.png"

function NewLevel20to29() {
  return (
    <>
      <div className="ct_mobile_width">
        <div className="ct_new_level_light_purple_bg ct_h-100 " style={{
          backgroundImage: `url(${newLavel20to29})`,
            ...
            <div className="mt-4">
              <div className="position-relative text-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="80" height="83" viewBox="0 0 80 83" fill="none">
                  <g filter="url(#filter0_i_5877_326)">
                    <path d="M40 0L79.8372 20.7V62.1L40 82.8L0.16283 62.1V20.7L40 0Z" fill="#9671FF" />
                  </g>
                  <defs>
                    <filter id="filter0_i_5877_326" x="0.163086" y="0" width="79.6738" height="82.8008" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                      ...
                      <feBlend mode="normal" in2="shape" result="effect1_innerShadow_5877_326" />
                    </filter>
                  </defs>
                </svg>
                <h2 className="ct_new_level_position">20</h2>
              </div>
              <p className="ct_9671FF_text_clr ct_fw_900 text-center mt-3 ct_fs_18 ct_letter_space_5 pb-20 mb-0"><i className="ct_fw_900">LEVEL NAME</i></p>
              <div className=" px-15">
