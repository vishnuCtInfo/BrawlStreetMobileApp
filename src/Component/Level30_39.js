    ...
    return (
        <>
            <div className="ct_mobile_width">
                <div className="ct_profile_gradient_bg_clr ct_level_light_pinnk_bg_clr pt-5 ct_pb_100">
                    <div className=" text-center">
                        ...
                        <p className="ct_F160A6_text_clr ct_fw_900 ct_fs_14 ct_letter_space_5 pb-20 mb-0"><i className="ct_fw_900">LEVEL NAME</i></p>
                        <div >
