...
import newLavel40to49 from "../img/new_level_40-49.png"
function NewLevel40to49() {
  return (
    <>
      <div className="ct_mobile_width">
        <div className="ct_new_level_light_red_bg ct_h-100 " style={{
          backgroundImage: `url(${newLavel40to49})`,
            ...
            <div className="mt-4">
              <div className="position-relative text-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="88" height="80" viewBox="0 0 88 80" fill="none">
                  <g filter="url(#filter0_i_5877_3108)">
                    <path d="M44 0L75.1127 11.5986L88 39.6L75.1127 67.6014L44 79.2L12.8873 67.6014L0 39.6L12.8873 11.5986L44 0Z" fill="#FF3F4A" />
                  </g>
                  <defs>
                    <filter id="filter0_i_5877_3108" x="0" y="0" width="88" height="79.1992" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                      ...
                      <feBlend mode="normal" in2="shape" result="effect1_innerShadow_5877_3108" />
                    </filter>
                  </defs>
                </svg>
                <h2 className="ct_new_level_position">40</h2>
              </div>
              <p className="ct_red_text ct_fw_900 text-center mt-3 ct_fs_18 ct_letter_space_5 pb-20 mb-0"><i className="ct_fw_900">LEVEL NAME</i></p>
              <div className=" px-15">
