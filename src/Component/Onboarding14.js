        ...
        <>
            <div className="ct_mobile_width">
                ...
                <div className='d-flex align-items-center justify-content-between pt-4'>
                        <NavLink to='/onboarding13'className='ct_mob_head pt-0'>
                    ...
                    <div className="ct_login_form pt-4 ct_h-100 ct_px_15">
                        <div className="w-100">
                            ...
                            <div className="ct_bottom_fixed" style={{bottom: '-20px'}}>
                                <div className="text-center mt-30">
                                    <NavLink to="/onboarding15" className="ct_blue_text text-center ct_fw_600 ct_fs_14" >Next</NavLink>
                                </div>
