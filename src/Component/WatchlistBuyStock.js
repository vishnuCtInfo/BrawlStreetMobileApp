        ...
        <div className=" ct_h-100 ">
            ...
            <div className="ct_mob_head d-flex align-items-center pb-12 px-15">
                ...
                <div className="flex-1">
                    <h4 className="text-center ct_fs_18 mb-0 ct_fw_700 ct_blue_text">BUY SHARES</h4>
            ...
            <div className="ct_white_bg px-15 ">
                <div className="pt-23">
                    ...
                    <div className="d-flex gap-3 pb-20">
                        ...
                        <div className="ct_col_50">
                            <p className="mb-0 ct_fw_400 ct_fs_13 mb-1 ct_7C7D7E_text_clr">Current price $</p>
                            <input type="number" placeholder="102.00" className="ct_select_option form-control w-100"/>
                        </div>
                    </div>
                    {/* Show this content when you choose instant  S  */}
                   {/* <!-- <div className="d-flex gap-3 d-none">
                    <div className="ct_col_50 ">
                        <p className="mb-0 ct_fw_400 ct_fs_13 mb-1 ct_7C7D7E_text_clr">Limit price $</p>
                        <input type="number" value="10,000.00" className="ct_select_option form-control w-100">
                    </div>
                    <div className="ct_col_50">
                        <p className="mb-0 ct_fw_400 ct_fs_13 mb-1 ct_7C7D7E_text_clr">Expiration</p>
                        <select className="ct_select_option form-control w-100">
                ...
                {/* <!-- Show this content when you choose instant  E --> */}
                </div>
                <div className="pt-23">
                    <div>
                        <div className="ct_border_btm pb-2">
                            <p className="mb-0 ct_fs_13 ct_7C7D7E_text_clr">Order summary</p>
                        </div>
                        <table className="table mb-0 ct_table_padd">
                            <tr className='ct_border_btm'>
                                <td className="px-0 ct_fs_13 ct_fw_500 ct_7C7D7E_text_clr">SUBTOTAL</td>
                                <td className="px-0 ct_fs_13 ct_fw_700 text-end">$10,901.30</td>
                            </tr>
                            <tr className='ct_border_btm'>
                                <td className="px-0 ct_fs_13 ct_fw_500 ct_7C7D7E_text_clr">VIRTUAL TRADE FEES</td>
                                <td className="px-0 ct_fs_13 ct_fw_700 text-end">$10</td>
                            </tr>

                        </table>
                        <div className="pt-2 ct_border_top">
                            ...
                            <div className="d-flex align-items-center justify-content-between pt-15">
                                <p className="px-0 ct_fs_13 ct_fw_500 mb-0 ct_grey_text_2 ct_7C7D7E_text_clr">REMAINING FUNDS</p>
            ...
            <div className="ct_grey_bg_clr ct_fixed_botom d-flex align-items-center gap-3">
                <a onClick={()=>HandleBuyOrderPlaced()} className="ct_button_blue ct_light_blue_btn">CONTINUE</a>
            </div>
        </div>
        ...
        <div className="modal-dialog">
            <div className="modal-content">
                <div className="modal-header border-0 pb-0">
                    ...
                    <button type='button' type="button" className="btn-close close" data-bs-dismiss="modal" aria-label="Close">
...
export default WatchlistBuyStock