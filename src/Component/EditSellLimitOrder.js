            ...
            <div className="ct_mobile_width">
                <div className="ct_login_bg ct_h-100 ">
                    <div className="ct_mob_head d-flex align-items-center pb-12 px-15">
                        <a onClick={() => HandleSellShares()} className="ct_mob_head pt-0">
                    ...
                    <div className="ct_grey_bg_clr ct_fixed_botom d-flex align-items-center gap-3">
                        <a onClick={() => HandleSellShares()} className="ct_button_blue ct_light_blue_btn">UPDATE ORDER</a>
                        <a onClick={() => HandleSellShares()} className="ct_button_blue ct_transparent_btn  ct_red_text ct_grey_border_btn">CANCEL ORDER</a>
                    </div>
                </div>
            </div>
        </>
...
export default EditSellLimitOrder
