...
function BuyOrderPlaced() {
    const navigate = useNavigate()
    const HandleEditBuyLimitOrder = () => {
                ...
                <div className=" px-15">
                    <div className="ct_login_form ct_center_css ct_h-100">
                        <div className="w-100">
                            ...
                            <h4 className="ct_fs_29 text-center ct_green_text ct_fw_700">Buy order placed</h4>
                            ...
                            <div className="ct_grey_bg_clr d-flex align-items-center gap-3 ct_fixed_botom">
                                <a onClick={() => HandleEditBuyLimitOrder()} className="ct_button_blue ct_light_blue_btn">DONE</a>
                            </div>
                        </div>
                    </div>
                </div>
