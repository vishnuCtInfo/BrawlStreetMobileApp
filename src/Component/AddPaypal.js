      ...
      <div className="ct_mobile_width">
        <div>
          <div className="ct_mob_head d-flex align-items-center pb-12 px-15">
            ...
            <h4 className="text-white text-center text-center flex-1 ct_fs_18 mb-0 ct_fw_600">ADD PAYPAL ACCOUNT</h4>
          </div>
          <div className="ct_white_bg pt-28 h-100">
            <div className="px-15">
              ...
              <div className="mt-4 text-center">
                <p className="mb-2 ct_fs_16 ct_7C7D7E_text_clr">You can use PayPal to deposit funds and receive any funds withdrawn from Brawl Street.</p>
              </div>
            </div>
          </div>
        </div>
        <div className="ct_grey_bg_clr ct_fixed_botom">
          <button type='button' className="ct_button_blue ct_light_blue_btn">CONNECT TO PAYPAL</button>
        </div>
      </div>
    </>
  )
