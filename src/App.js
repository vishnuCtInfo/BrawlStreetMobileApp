    ...
    <div className="App">
      <Router basename="/mobile">
        <Routes>
          ...
          <Route
            path="/add/funds/sucessfull"
            element={<AddFundsSuccessfull />}
          ></Route>
          <Route
          ...
          <Route
            path="/buy/order/successfull"
            element={<BuyOrderSuccessfull />}
          ></Route>
          ...
          <Route
            path="/withdrawl/review/confirm"
            element={<WithdrawReviewConfirm />}
          ></Route>
          <Route
            path="/withdrawl/insufficient/funds"
            element={<WithdrawInsufficientFunds />}
          ></Route>
          <Route
            path="/withdrawl/complete"
            element={<WithdrawComplete />}
          ></Route>
          <Route path="/watchlist" element={<Watchlist />}></Route>
          <Route
            path="/watchlist/stock/detail"
            element={<WatchlistStockDetail />}
          ></Route>
          <Route
            path="/watchlist/buy/stock"
            element={<WatchlistBuyStock />}
          ></Route>
          <Route
            path="/watchlist/buy/order/successfull"
            element={<WatchListBuyOrderSuccessfull />}
          ></Route>
          <Route path="/wallet" element={<Wallet />}></Route>
          <Route path="/view/referrals" element={<ViewReferrals />}></Route>
          <Route
            path="/varification/email"
            element={<VarificationEmail />}
          ></Route>
          ...
          <Route
            path="/sell/shares/sucessfull"
            element={<SellSharesSucessfull />}
          ></Route>
          <Route
            path="/sell/order/placed"
            element={<SellOrderPlaced />}
          ></Route>
          ...
          <Route
            path="/open/games/detail"
            element={<OpenGamesDetail />}
          ></Route>
